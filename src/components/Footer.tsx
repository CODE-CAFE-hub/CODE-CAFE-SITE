const Footer: React.FC = () => {
  return (
    <div>
      <footer className="p-10 bg-[#130726]  bg-center bg-no-repeat  px-14 ">
      <hr className="mb-10" />
        <div className="md:flex items-center justify-between footer text-base-content  ">
        <nav>
            <h6 className="footer-title">Contact</h6>
            <a className="link link-hover">📧  Email - Email@gmail.com</a>
            <a className="link link-hover">📱  Mobile No - +91 494162626</a>
            <a className="link link-hover"> 📢 Address - Discord</a>
          </nav>
          <nav>
      ...
      <footer className="footer items-center p-4 bg-[#0f061d] text-neutral-content px-16">
